...
public class Camera2VideoFragment extends Fragment
    ...
    private static final String DEFAULT_VIDEO_DIRECTORY_NAME = "/RECORD";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.camera_view_layout, container, false);
    }
        ...
        switch (view.getId()) {
            case R.id.record: {
                ...
                if (mIsRecordingVideo) {
                    ...
                    Toast.makeText(activity,"Now Calling Classifier", Toast.LENGTH_SHORT).show();
                } else {
                    startRecordingVideo();
                }
                break;
    ...
    private void stopRecordingVideo() {
        ...
        if (null != activity) {
            ...
            passData(mNextVideoAbsolutePath);
